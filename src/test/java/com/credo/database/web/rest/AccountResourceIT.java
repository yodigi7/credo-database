...
import static com.credo.database.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.credo.database.IntegrationTest;
import com.credo.database.config.Constants;
import com.credo.database.domain.User;
import com.credo.database.repository.AuthorityRepository;
...
import com.credo.database.web.rest.vm.KeyAndPasswordVM;
...
class AccountResourceIT {
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.WRITER));
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.WRITER));
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.WRITER));
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.WRITER).get());
    }
