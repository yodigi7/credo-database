...
/**
 * Criteria class for the {@link com.credo.database.domain.PersonPhone} entity. This class is used
 * in {@link com.credo.database.web.rest.PersonPhoneResource} to receive all the possible filtering options from
...
public class PersonPhoneCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, phoneNumber, type, personId);
    }
