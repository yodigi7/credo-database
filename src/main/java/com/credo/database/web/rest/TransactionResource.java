...
import com.credo.database.service.TransactionQueryService;
import com.credo.database.service.TransactionService;
...
/**
 * REST controller for managing {@link com.credo.database.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
