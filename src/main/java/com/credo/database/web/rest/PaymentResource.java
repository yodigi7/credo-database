...
import com.credo.database.service.PaymentQueryService;
import com.credo.database.service.PaymentService;
...
/**
 * REST controller for managing {@link com.credo.database.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
