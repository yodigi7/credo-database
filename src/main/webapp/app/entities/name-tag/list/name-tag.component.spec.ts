...
describe('Component Tests', () => {
  describe('NameTag Management Component', () => {
    let comp: NameTagComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NameTagComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.nameTags?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
