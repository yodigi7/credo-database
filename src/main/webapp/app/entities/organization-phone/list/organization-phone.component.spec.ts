...
describe('Component Tests', () => {
  describe('OrganizationPhone Management Component', () => {
    let comp: OrganizationPhoneComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OrganizationPhoneComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.organizationPhones?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
