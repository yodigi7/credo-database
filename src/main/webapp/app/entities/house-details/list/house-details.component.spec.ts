...
describe('Component Tests', () => {
  describe('HouseDetails Management Component', () => {
    let comp: HouseDetailsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(HouseDetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.houseDetails?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
