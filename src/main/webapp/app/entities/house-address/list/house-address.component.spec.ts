...
describe('Component Tests', () => {
  describe('HouseAddress Management Component', () => {
    let comp: HouseAddressComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(HouseAddressComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.houseAddresses?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
