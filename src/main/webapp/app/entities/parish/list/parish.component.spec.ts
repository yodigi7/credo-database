...
describe('Component Tests', () => {
  describe('Parish Management Component', () => {
    let comp: ParishComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ParishComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.parishes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
