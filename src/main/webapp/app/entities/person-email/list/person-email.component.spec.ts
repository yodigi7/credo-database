...
describe('Component Tests', () => {
  describe('PersonEmail Management Component', () => {
    let comp: PersonEmailComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PersonEmailComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.personEmails?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
