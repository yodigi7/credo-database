    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            membershipStartDate: currentDate.format(DATE_FORMAT),
            membershipExpirationDate: currentDate.format(DATE_FORMAT),
          },
          elemDefault
        );
      ...
      describe('addPersonToCollectionIfMissing', () => {
        ...
        it('should add only unique Person to an array', () => {
          const personArray: IPerson[] = [{ id: 123 }, { id: 456 }, { id: 41668 }];
