...
describe('Component Tests', () => {
  describe('Ribbon Management Component', () => {
    let comp: RibbonComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RibbonComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ribbons?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
