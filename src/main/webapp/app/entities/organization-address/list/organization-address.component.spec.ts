...
describe('Component Tests', () => {
  describe('OrganizationAddress Management Component', () => {
    let comp: OrganizationAddressComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OrganizationAddressComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.organizationAddresses?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
